...
class ClimateSettingsPage extends PresetEditorPage {
	...
	public Component title() {
		return Component.translatable(NTTranslationKeys.GUI_CLIMATE_SETTINGS_TITLE);
	}
	...
	public void init() {
		...
		this.temperatureSeedOffset = PresetWidgets.createRandomButton(NTTranslationKeys.GUI_BUTTON_CLIMATE_SEED_OFFSET, temperature.seedOffset, (value) -> {
			temperature.seedOffset = value;
			this.regenerate();
		});
		this.temperatureScale = PresetWidgets.createIntSlider(temperature.scale, 1, 20, NTTranslationKeys.GUI_SLIDER_TEMPERATURE_SCALE, (slider, value) -> {
			temperature.scale = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.temperatureFalloff = PresetWidgets.createIntSlider(temperature.falloff, 1, 10, NTTranslationKeys.GUI_SLIDER_TEMPERATURE_FALLOFF, (slider, value) -> {
			temperature.falloff = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.temperatureMin = PresetWidgets.createFloatSlider(temperature.min, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_TEMPERATURE_MIN, (slider, value) -> {
			temperature.min = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.temperatureMax = PresetWidgets.createFloatSlider(temperature.max, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_TEMPERATURE_MAX, (slider, value) -> {
			temperature.max = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.temperatureBias = PresetWidgets.createFloatSlider(temperature.bias, -1.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_TEMPERATURE_BIAS, (slider, value) -> {
		...
		this.moistureSeedOffset = PresetWidgets.createRandomButton(NTTranslationKeys.GUI_BUTTON_CLIMATE_SEED_OFFSET, moisture.seedOffset, (value) -> {
			moisture.seedOffset = value;
			this.regenerate();
		});
		this.moistureScale = PresetWidgets.createIntSlider(moisture.scale, 1, 20, NTTranslationKeys.GUI_SLIDER_MOISTURE_SCALE, (slider, value) -> {
			moisture.scale = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.moistureFalloff = PresetWidgets.createIntSlider(moisture.falloff, 1, 10, NTTranslationKeys.GUI_SLIDER_MOISTURE_FALLOFF, (slider, value) -> {
			moisture.falloff = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.moistureMin = PresetWidgets.createFloatSlider(moisture.min, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_MOISTURE_MIN, (slider, value) -> {
			moisture.min = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.moistureMax = PresetWidgets.createFloatSlider(moisture.max, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_MOISTURE_MAX, (slider, value) -> {
			moisture.max = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.moistureBias = PresetWidgets.createFloatSlider(moisture.bias, -1.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_MOISTURE_BIAS, (slider, value) -> {
		...
		this.biomeSize = PresetWidgets.createIntSlider(biomeShape.biomeSize, 50, 2000, NTTranslationKeys.GUI_SLIDER_BIOME_SIZE, (slider, value) -> {
			biomeShape.biomeSize = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.macroNoiseSize = PresetWidgets.createIntSlider(biomeShape.macroNoiseSize, 1, 20, NTTranslationKeys.GUI_SLIDER_MACRO_NOISE_SIZE, (slider, value) -> {
			biomeShape.macroNoiseSize = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeWarpScale = PresetWidgets.createIntSlider(biomeShape.biomeWarpScale, 1, 500, NTTranslationKeys.GUI_SLIDER_BIOME_WARP_SCALE, (slider, value) -> {
			biomeShape.biomeWarpScale = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeWarpStrength = PresetWidgets.createIntSlider(biomeShape.biomeWarpStrength, 1, 500, NTTranslationKeys.GUI_SLIDER_BIOME_WARP_STRENGTH, (slider, value) -> {
		...
		this.biomeEdgeType = PresetWidgets.createCycle(ClimateSettings.BiomeNoise.EdgeType.values(), biomeEdgeShape.type, NTTranslationKeys.GUI_BUTTON_BIOME_EDGE_TYPE, (button, value) -> {
			biomeEdgeShape.type = value;
			this.regenerate();
		});
		this.biomeEdgeScale = PresetWidgets.createIntSlider(biomeEdgeShape.scale, 1, 500, NTTranslationKeys.GUI_SLIDER_BIOME_EDGE_SCALE, (slider, value) -> {
			biomeEdgeShape.scale = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeEdgeOcaves = PresetWidgets.createIntSlider(biomeEdgeShape.octaves, 1, 5, NTTranslationKeys.GUI_SLIDER_BIOME_EDGE_OCTAVES, (slider, value) -> {
			biomeEdgeShape.octaves = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeEdgeGain = PresetWidgets.createFloatSlider(biomeEdgeShape.gain, 0.0F, 5.5F, NTTranslationKeys.GUI_SLIDER_BIOME_EDGE_GAIN, (slider, value) -> {
			biomeEdgeShape.gain = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeEdgeLacunarity = PresetWidgets.createFloatSlider(biomeEdgeShape.lacunarity, 0.0F, 10.5F, NTTranslationKeys.GUI_SLIDER_BIOME_EDGE_LACUNARITY, (slider, value) -> {
			biomeEdgeShape.lacunarity = (float) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		this.biomeEdgeStrength = PresetWidgets.createIntSlider(biomeEdgeShape.strength, 1, 500, NTTranslationKeys.GUI_SLIDER_BIOME_EDGE_STRENGTH, (slider, value) -> {
			biomeEdgeShape.strength = (int) slider.scaleValue(value);
			this.regenerate();
			return value;
		});
		
		this.left.addWidget(PresetWidgets.createLabel(NTTranslationKeys.GUI_LABEL_TEMPERATURE));
		...
		this.left.addWidget(PresetWidgets.createLabel(NTTranslationKeys.GUI_LABEL_MOISTURE));
		...
		this.left.addWidget(PresetWidgets.createLabel(NTTranslationKeys.GUI_LABEL_BIOME_SHAPE));
		...
		this.left.addWidget(PresetWidgets.createLabel(NTTranslationKeys.GUI_LABEL_BIOME_EDGE_SHAPE));
