...
import neoterra.world.worldgen.densityfunction.tile.filter.BeachDetect;
import neoterra.world.worldgen.densityfunction.tile.filter.Erosion;
import neoterra.world.worldgen.densityfunction.tile.filter.Filterable;
import neoterra.world.worldgen.densityfunction.tile.filter.NoiseCorrection;
import neoterra.world.worldgen.densityfunction.tile.filter.Smoothing;
import neoterra.world.worldgen.densityfunction.tile.filter.Steepness;
