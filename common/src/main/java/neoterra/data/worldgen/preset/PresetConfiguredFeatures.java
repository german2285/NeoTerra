...
import neoterra.data.worldgen.preset.settings.SurfaceSettings;
import neoterra.world.worldgen.feature.BushFeature;
import neoterra.world.worldgen.feature.DecorateSnowFeature;
...
public class PresetConfiguredFeatures {
	...
	public static void bootstrap(Preset preset, BootstrapContext<ConfiguredFeature<?, ?>> ctx) {
		...
		if(miscellaneous.erosionDecorator) {
			FeatureUtils.register(ctx, ERODE, NTFeatures.ERODE, erodeConfig);
		}
		
		if(miscellaneous.naturalSnowDecorator || miscellaneous.smoothLayerDecorator) {
			FeatureUtils.register(ctx, DECORATE_SNOW, NTFeatures.DECORATE_SNOW, new DecorateSnowFeature.Config(miscellaneous.naturalSnowDecorator, miscellaneous.smoothLayerDecorator, erodeConfig));
		}
		
		FeatureUtils.register(ctx, SWAMP_SURFACE, NTFeatures.SWAMP_SURFACE, new SwampSurfaceFeature.Config(Blocks.CLAY.defaultBlockState(), Blocks.GRAVEL.defaultBlockState(), Blocks.DIRT.defaultBlockState()));
		...
		if(miscellaneous.customBiomeFeatures) {
			...
			FeatureUtils.register(ctx, OAK_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.OAK_SMALL));
			FeatureUtils.register(ctx, OAK_FOREST, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.OAK_FOREST));
			FeatureUtils.register(ctx, OAK_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.OAK_LARGE));
			FeatureUtils.register(ctx, BIRCH_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.BIRCH_SMALL));
			FeatureUtils.register(ctx, BIRCH_FOREST, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.BIRCH_FOREST));
			FeatureUtils.register(ctx, BIRCH_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.BIRCH_LARGE));
			FeatureUtils.register(ctx, ACACIA_BUSH, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.ACACIA_BUSH, 2));
			FeatureUtils.register(ctx, ACACIA_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.ACACIA_SMALL));
			FeatureUtils.register(ctx, ACACIA_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.ACACIA_LARGE));
			FeatureUtils.register(ctx, DARK_OAK_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.DARK_OAK_SMALL));
			FeatureUtils.register(ctx, DARK_OAK_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.DARK_OAK_LARGE));
			FeatureUtils.register(ctx, HUGE_BROWN_MUSHROOM, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.BROWN_MUSHROOM, 0));
			FeatureUtils.register(ctx, HUGE_RED_MUSHROOM, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.RED_MUSHROOM));
			FeatureUtils.register(ctx, WILLOW_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.WILLOW_SMALL));
			FeatureUtils.register(ctx, WILLOW_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.WILLOW_LARGE));
			FeatureUtils.register(ctx, PINE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.PINE));
			FeatureUtils.register(ctx, SPRUCE_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.SPRUCE_SMALL));
			FeatureUtils.register(ctx, SPRUCE_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.SPRUCE_LARGE));
			FeatureUtils.register(ctx, REDWOOD_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.REDWOOD_LARGE));
			FeatureUtils.register(ctx, REDWOOD_HUGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.REDWOOD_HUGE));
			FeatureUtils.register(ctx, JUNGLE_SMALL, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.JUNGLE_SMALL));
			FeatureUtils.register(ctx, JUNGLE_LARGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.JUNGLE_LARGE));
			FeatureUtils.register(ctx, JUNGLE_HUGE, NTFeatures.TEMPLATE, makeTree(PresetTemplatePaths.JUNGLE_HUGE));
			
			FeatureUtils.register(ctx, MARSH_BUSH, NTFeatures.BUSH, makeSmallBush(Blocks.OAK_LOG, Blocks.BIRCH_LEAVES, 0.05F, 0.09F, 0.65F));
			FeatureUtils.register(ctx, PLAINS_BUSH, NTFeatures.BUSH, makeSmallBush(Blocks.OAK_LOG, Blocks.BIRCH_LEAVES, 0.05F, 0.09F, 0.65F));
			FeatureUtils.register(ctx, STEPPE_BUSH, NTFeatures.BUSH, makeSmallBush(Blocks.ACACIA_LOG, Blocks.ACACIA_LEAVES, 0.06F, 0.08F, 0.7F));
			FeatureUtils.register(ctx, COLD_STEPPE_BUSH, NTFeatures.BUSH, makeSmallBush(Blocks.SPRUCE_LOG, Blocks.OAK_LEAVES, 0.05F, 0.075F, 0.6F));
			FeatureUtils.register(ctx, TAIGA_SCRUB_BUSH, NTFeatures.BUSH, makeSmallBush(Blocks.SPRUCE_LOG, Blocks.SPRUCE_LEAVES, 0.05F, 0.075F, 0.6F));
			...
			FeatureUtils.register(ctx, BIRCH_TREES, NTFeatures.CHANCE, makeChance(
				makeChanceEntry(birchLarge, 0.2F, NTChanceModifiers.elevation(0.25F, 0.0F), NTChanceModifiers.biomeEdge(0.1F, 0.3F)),
				makeChanceEntry(birchForest, 0.2F, NTChanceModifiers.elevation(0.3F, 0.0F), NTChanceModifiers.biomeEdge(0.05F, 0.2F)),
				makeChanceEntry(birchSmall, 0.1F, NTChanceModifiers.biomeEdge(0.25F, 0.0F)),
				makeChanceEntry(birchSmall, 0.1F, NTChanceModifiers.elevation(0.25F, 0.65F))
			));
			...
			FeatureUtils.register(ctx, FIR_TREES, NTFeatures.CHANCE, makeChance(
				makeChanceEntry(spruceSmall, 0.1F, NTChanceModifiers.elevation(0.55F, 0.2F)),
				makeChanceEntry(spruceLarge, 0.25F, NTChanceModifiers.elevation(0.3F, 0.0F))
			));
			FeatureUtils.register(ctx, REDWOOD_TREES, NTFeatures.CHANCE, makeChance(
				makeChanceEntry(redwoodHuge, 0.4F, NTChanceModifiers.elevation(0.15F, 0.0F), NTChanceModifiers.biomeEdge(0.1F, 0.3F)),
				makeChanceEntry(redwoodLarge, 0.2F, NTChanceModifiers.elevation(0.25F, 0.0F), NTChanceModifiers.biomeEdge(0.05F, 0.25F)),
				makeChanceEntry(spruceLarge, 0.4F, NTChanceModifiers.elevation(0.35F, 0.15F)),
				makeChanceEntry(spruceSmall, 0.2F, NTChanceModifiers.elevation(0.5F, 0.2F))
			));
	        ...
	        FeatureUtils.register(ctx, MiscOverworldFeatures.DISK_CLAY, NTFeatures.DISK, new DiskConfiguration(RuleBasedBlockStateProvider.simple(Blocks.CLAY), BlockPredicate.matchesBlocks(List.of(Blocks.DIRT, Blocks.CLAY)), UniformInt.of(2, 3), 1));
	...
	protected static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, NTCommon.location(name));
	}
}
