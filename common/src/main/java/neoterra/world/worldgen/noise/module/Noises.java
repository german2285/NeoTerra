...
import neoterra.world.worldgen.noise.function.CellFunction;
...
public class Noises {
    private static final Codec<Noise> CODEC = NTBuiltInRegistries.NOISE_TYPE.byNameCodec().dispatch(Noise::codec, Function.identity());
