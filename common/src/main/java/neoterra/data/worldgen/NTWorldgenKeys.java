...
public final class NTWorldgenKeys {
	...
	public static final ResourceKey<NoiseGeneratorSettings> OVERWORLD_NOISE_SETTINGS =
		ResourceKey.create(Registries.NOISE_SETTINGS, NTCommon.location("overworld"));
