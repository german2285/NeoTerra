...
import neoterra.world.worldgen.biome.modifier.fabric.FabricBiomeModifier;
...
public class MixinBiomeModificationImpl {
	...
	public List<Object> getSortedModifiers(BiomeModificationImpl self, RegistryAccess registries) {
		...
		for(Holder.Reference<BiomeModifier> holder : registries.lookupOrThrow(NTRegistries.BIOME_MODIFIER).listElements().toList()) {
