...
import neoterra.data.worldgen.preset.settings.ClimateSettings.BiomeNoise;
import neoterra.data.worldgen.preset.settings.ClimateSettings.BiomeShape;
import neoterra.data.worldgen.preset.settings.ClimateSettings.RangeValue;
...
public class Presets {
	...
	public static Preset makeNTDefault() {
		return new Preset(
			new WorldSettings(
