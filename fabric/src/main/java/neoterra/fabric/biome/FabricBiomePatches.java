...
public final class FabricBiomePatches {
	...
	public static void register() {
		NTCommon.debug("FabricBiomePatches.register: registering replace and add modifiers via Fabric BiomeModifications API");
		registerReplaces();
		registerAdds();
		NTCommon.debug("FabricBiomePatches.register: done");
	}
