...
public class MiscellaneousPage extends PresetEditorPage {
	...
	public Component title() {
		return Component.translatable(NTTranslationKeys.GUI_MISCELLANEOUS_SETTINGS_TITLE);
	}
	...
	public void init() {
		...
		this.smoothLayerDecorator = PresetWidgets.createToggle(miscellaneous.smoothLayerDecorator, NTTranslationKeys.GUI_BUTTON_SMOOTH_LAYER_DECORATOR, (button, value) -> {
			miscellaneous.smoothLayerDecorator = value;
		});
		this.strataRegionSize = PresetWidgets.createIntSlider(miscellaneous.strataRegionSize, 50, 1000, NTTranslationKeys.GUI_SLIDER_STRATA_REGION_SIZE, (slider, value) -> {
			miscellaneous.strataRegionSize = (int) slider.scaleValue(value);
			return value;
		});
		this.strataDecorator = PresetWidgets.createToggle(miscellaneous.strataDecorator, NTTranslationKeys.GUI_BUTTON_STRATA_DECORATOR, (button, value) -> {
			miscellaneous.strataDecorator = value;
		});
		this.oreCompatibleStoneOnly = PresetWidgets.createToggle(miscellaneous.oreCompatibleStoneOnly, NTTranslationKeys.GUI_BUTTON_ORE_COMPATIBLE_STONE_ONLY, (button, value) -> {
			miscellaneous.oreCompatibleStoneOnly = value;
		});
		this.erosionDecorator = PresetWidgets.createToggle(miscellaneous.erosionDecorator, NTTranslationKeys.GUI_BUTTON_EROSION_DECORATOR, (button, value) -> {
			miscellaneous.erosionDecorator = value;
		});
		this.plainStoneErosion = PresetWidgets.createToggle(miscellaneous.plainStoneErosion, NTTranslationKeys.GUI_BUTTON_PLAIN_STONE_EROSION, (button, value) -> {
			miscellaneous.plainStoneErosion = value;
		});
		this.naturalSnowDecorator = PresetWidgets.createToggle(miscellaneous.naturalSnowDecorator, NTTranslationKeys.GUI_BUTTON_NATURAL_SNOW_DECORATOR, (button, value) -> {
			miscellaneous.naturalSnowDecorator = value;
		});
		this.customBiomeFeatures = PresetWidgets.createToggle(miscellaneous.customBiomeFeatures, NTTranslationKeys.GUI_BUTTON_CUSTOM_BIOME_FEATURES, (button, value) -> {
			miscellaneous.customBiomeFeatures = value;
		});
		this.vanillaSprings = PresetWidgets.createToggle(miscellaneous.vanillaSprings, NTTranslationKeys.GUI_BUTTON_VANILLA_SPRINGS, (button, value) -> {
			miscellaneous.vanillaSprings = value;
		});
		this.vanillaLavaLakes = PresetWidgets.createToggle(miscellaneous.vanillaLavaLakes, NTTranslationKeys.GUI_BUTTON_VANILLA_LAVA_LAKES, (button, value) -> {
			miscellaneous.vanillaLavaLakes = value;
		});
		this.vanillaLavaSprings = PresetWidgets.createToggle(miscellaneous.vanillaLavaSprings, NTTranslationKeys.GUI_BUTTON_VANILLA_LAVA_SPRINGS, (button, value) -> {
			miscellaneous.vanillaLavaSprings = value;
		});
		this.mountainBiomeUsage = PresetWidgets.createFloatSlider(miscellaneous.mountainBiomeUsage, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_MOUNTAIN_BIOME_USAGE, (slider, value) -> {
			miscellaneous.mountainBiomeUsage = (float) slider.scaleValue(value);
			return value;
		});
		this.volcanoBiomeUsage = PresetWidgets.createFloatSlider(miscellaneous.volcanoBiomeUsage, 0.0F, 1.0F, NTTranslationKeys.GUI_SLIDER_VOLCANO_BIOME_USAGE, (slider, value) -> {
